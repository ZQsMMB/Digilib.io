...
<div class="modal hide fade" id="modalEdit<?=$i?>" tabindex="-1" role="dialog" aria-labelledby="modalEdit<?=$i?>Label" aria-hidden="true">
  <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
    <h4 id="modalEdit<?=$i?>">Edit Mahasiswa</h4> <!--Ubah dari Awalnya Edit Petugas(PPT Page 13)-->
  </div>
  <div class="modal-body">
      <div class="row-fluid">
...
<div class="modal hide fade" id="modalTambah" tabindex="-1" role="dialog" aria-labelledby="modalTambahLabel" aria-hidden="true">
  <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
    <h4 id="modalTambah">Tambah Mahasiswa</h4> <!--Ubah dari Awalnya Tambah Buku(PPT Page12)-->
  </div>
  <div class="modal-body">
      <div class="row-fluid">
		<input type="hidden" name="tum" id="tum">
		<div>
			<label><p class="title">Nama</p>
			  <input name="nama" type="text" class="span12" value="" required="required"> <!--Menambahkan fungsi requierd field harus terisi (Page 10 PPT)-->
			</label>
			</label>
			<label><p class="title">Username</p>
			  <input name="username" type="text" class="span12" value=""required="required"> <!--Menambahkan fungsi requierd field harus terisi (Page 10 PPT)-->
			</label>
			</label>
			<label><p class="title">Password</p>
			  <input name="password" type="password" class="span12" value=""required="required"> <!--Menambahkan fungsi requierd field harus terisi (Page 10 PPT)-->
			</label>
			</label>
			<label><p class="title">Email</p>
			  <input name="email" type="email" class="span12" value=""> <!-- Ganti data type dari Teks menjadi Email dan isi value yang tadinya kosong (Page 10 PPT)-->
			</label>
			<label><p class="title">Tempat Lahir</p>
