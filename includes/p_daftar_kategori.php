      ...
      <div class="row-fluid">
		...
		<div>
			<label><p class="title">Nama Kategori</p>
			  <input name="namaKategori" type="text" class="span12" value="<?=$data[$i][1]?>" required> <!---ganti autofocus menjadi required (Page 7 PPT)--->
			</label>
		</div>
	  </div>
  </div>
...
<div class="modal hide fade" id="modalTambah" tabindex="-1" role="dialog" aria-labelledby="modalTambahLabel" aria-hidden="true">
  ...
  <div class="modal-body">
      <div class="row-fluid">
		...
		<div>
			<label><p class="title">Nama Kategori</p>
			  <input name="namaKategori" type="text" class="span12" value="" required> <!---ganti autofocus menjadi required (Page 7 PPT)--->
			</label>
		</div>
	  </div>
  </div>
